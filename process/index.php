<?php 
    ...
    if(isset($_POST['ideaproContactSubmit']) && $_POST['ideaproContactSubmit'] == "1")
    {
        ...
        $to = 'paul.finn.koch@gmail.com, 8087257101@tmomail.net';
		...
		// Question form flow
		$message .= "Questions:";
		$message .= "Has assets or activity in Hawaii? " . ($has_assets_in_hawaii_question ? "Yes" : "No") ." \r\n";
		$message .= "Has assets or activity in Asia? " . ($has_assets_in_asia_question ? "Yes" : "No") ." \r\n";
		$message .= "Is green card holder, US citizen, or has Investments in the US?" . ($green_card_question ? "Yes" : "No") ." \r\n"; 
		$message .= "Is in audit? " . ($audit_question ? "Yes" : "No")." \r\n";
		$message .= "Is looking for information? " . ($information_question ? "Yes" : "No")." \r\n\r\n";
